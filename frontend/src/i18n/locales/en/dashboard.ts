export default {
  ...
  usage: {
    ...
    tabs: { usage: 'Usage', errors: 'Error Requests', ranking: 'User Ranking', performance: 'Upstream Performance' },
    performance: {
      title: 'Upstream Performance',
      description: 'Response metrics aggregated from real traffic without probes or routing changes.',
      last24h: 'Last 24 hours',
      last7d: 'Last 7 days',
      loading: 'Loading performance metrics...',
      readOnly: 'Read-only metrics',
      warningLegend: 'Yellow: first-token P50 >= 3s or P95 >= 8s; red: success rate < 98%',
      ...
      totalP50: 'Total P50',
      totalP95: 'Total P95',
      noData: 'No traffic in this time range',
      failedToLoad: 'Failed to load upstream performance metrics',
    },
    errors: {
