export default {
  ...
  usage: {
    ...
    tabs: { usage: '用量明细', errors: '错误请求', ranking: '用户排行', performance: '上游性能' },
    performance: {
      title: '上游性能',
      description: '按真实业务请求汇总分组与账号的响应表现，不主动探测或修改路由。',
      last24h: '近 24 小时',
      last7d: '近 7 天',
      loading: '正在加载性能统计...',
      readOnly: '只读统计',
      warningLegend: '黄色：首字 P50 >= 3 秒或 P95 >= 8 秒；红色：成功率 < 98%',
      groups: '分组表现',
      accounts: '账号表现',
      name: '名称',
      requests: '样本量',
